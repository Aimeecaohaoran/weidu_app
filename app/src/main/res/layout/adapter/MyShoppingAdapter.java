...
import com.example.work_three.bean.ShowShoppingBean;
import com.example.work_three.view.MyCustomView;
...
public class MyShoppingAdapter extends XRecyclerView.Adapter<XRecyclerView.ViewHolder> {
    ...
    @NonNull
    @Override
    public com.example.work_three.adapter.MyShoppingAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    ...
    public void onBindViewHolder(@NonNull final XRecyclerView.ViewHolder viewHolder, final int i) {
        ...
        holder.sd_shop_sim.setImageURI(mlist.get(i).getPic());
       // Glide.with(context).load(mlist.get(i).getPic()).into(holder.sd_shop_sim);
        ...
        holder.cus_view.setDAta(com.example.work_three.adapter.MyShoppingAdapter.this,mlist,i);
