...
public class TopHomeAdapter extends RecyclerView.Adapter<com.example.work_three.adapter.TopHomeAdapter.TopRecyclerView> {

    private List<TopLasBean.ResultBean> mList;
    private Context mContext;

    public TopHomeAdapter(Context mContext,List<TopLasBean.ResultBean> mList) {
